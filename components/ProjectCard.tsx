		...
		<div>
			<div className="relative w-full group">
				...
				<div
					...
					className="absolute w-fit flex top-[50%] smOnly:hidden -translate-x-[30%] -translate-y-1/2 overflow-hidden z-10 group-hover:opacity-100 opacity-0 transition duration-500 ease-[.4,0,.2,1] xm:hidden">
					{Array.from(item.title ?? "").map((item: any, i: any) => (
						<motion.span
							initial={{ y: "100%" }}
