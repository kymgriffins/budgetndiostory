          ...
          <main id="landing-content">
              ...
              <div className="max-w-[1200px] mx-auto">
                <div className="grid grid-cols-2 gap-[28px] mdOnly:grid-cols-1 smOnly:grid-cols-1 xm:grid-cols-1 items-start">
                  <div>
                    ...
                    >
                      Budget Ndio Story turns budgets into clear, local
                      narratives—videos, field reports, podcasts and photo
                      essays that show what was budgeted, what exists on the
                      ground, and who benefits. Evidence-first, youth-focused,
                      and built for civic action.
                    </p>
            ...
            <section className="padding-x pt-[30px]">
              <div className="max-w-[1200px] mx-auto">
                ...
                >
                  <div
                    data-animate="card"
                    className="rounded-[22px] bg-white/80 border border-black/5 p-[16px]"
                  >
                  ...
                  <div
                    data-animate="card"
                    className="rounded-[22px] bg-[#212121] text-[#f1f1f1] border border-black/10 p-[16px]"
                  >
                    <p className="small-text font-NeueMontreal text-[#f1f1f1]/60">
                      Participation
                    </p>
            ...
            <section className="padding-x padding-y">
              <div className="max-w-[1200px] mx-auto">
                <div
                  data-animate="fade-up"
                  className="flex items-end justify-between gap-[16px] flex-wrap"
                >
                  ...
                  <p className="paragraph font-NeueMontreal text-[#212121]/70 max-w-[60ch]">
                    Real reports and short features that answer: What was
                ...
                >
                  <div
                    data-animate="card"
                    className="rounded-[24px] bg-white/80 border border-black/5 p-[20px]"
                  >
                    <p className="small-text font-NeueMontreal text-[#212121]/60">
                      Report 01
                    </p>
                    <p className="text-[22px] font-NeueMontreal text-[#111] mt-[10px]">
                      This road was budgeted for Ksh 5M
                    </p>
                    <p className="paragraph font-NeueMontreal text-[#212121]/70 mt-[10px]">
                      Field verification from the county shows partial
                      completion and missing signboards.
                    </p>
                  </div>
                  <div
                    data-animate="card"
                  ...
                  >
                    ...
                    <p className="paragraph font-NeueMontreal text-[#212121]/70 mt-[10px]">
                      A short investigation into procurement and delivery
                  ...
                  >
                    ...
                    <p className="paragraph font-NeueMontreal text-[#212121]/70 mt-[10px]">
                      First-hand accounts from residents about local projects
                      and their impact.
                    </p>
                  </div>
                  <div
                    data-animate="card"
                    className="rounded-[24px] bg-[#111] text-[#f1f1f1] border border-black/10 p-[20px]"
                  >
                    <p className="small-text font-NeueMontreal text-[#f1f1f1]/60">
                      Report 05
                    </p>
                    <p className="text-[22px] font-NeueMontreal mt-[10px]">
                      Data snapshots
                    </p>
                    <p className="paragraph font-NeueMontreal text-[#f1f1f1]/70 mt-[10px]">
                      Visual summaries of budgets and spending for quick civic
                      review.
                    </p>
                  </div>
                  <div
                    data-animate="card"
                    className="rounded-[24px] bg-[#212121] text-[#f1f1f1] border border-black/10 p-[20px]"
                  >
                    <p className="small-text font-NeueMontreal text-[#f1f1f1]/60">
                      Report 06
                    </p>
                    ...
                    <p className="paragraph font-NeueMontreal text-[#f1f1f1]/70 mt-[10px]">
                      Share evidence, sign petitions, or contact your county
                      reps—small steps towards accountability.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section className="padding-x pb-[30px]">
              <div className="max-w-[1200px] mx-auto">
                <div
                  data-animate="fade-up"
                  className="rounded-[30px] bg-white/70 border border-black/5 p-[22px] smOnly:p-[18px] xm:p-[16px]"
                >
                  ...
                  <div
                    data-animate="cards"
                    className="mt-[18px] grid grid-cols-3 gap-[14px] mdOnly:grid-cols-1 smOnly:grid-cols-1 xm:grid-cols-1"
                  >
                    <div
                      data-animate="card"
                      className="rounded-[22px] bg-white border border-black/5 p-[18px]"
                    >
                      <p className="small-text font-NeueMontreal text-[#212121]/60">
                        Step 01
                      </p>
            ...
            <section className="padding-x padding-y">
              <div className="max-w-[1200px] mx-auto">
                ...
                >
                  <div
                    data-animate="card"
                    className="rounded-[26px] overflow-hidden bg-white border border-black/5"
                  >
                    <div className="p-[18px]">
                      <p className="small-text font-NeueMontreal text-[#212121]/60">
                        Budget Tracker
                      </p>
                      <p className="paragraph font-NeueMontreal mt-[8px]">
                        See allocations by sector
                      </p>
                    </div>
                  ...
                  <div
                    data-animate="card"
                    className="rounded-[26px] overflow-hidden bg-[#111] border border-black/10"
                  >
                    <div className="p-[18px]">
                      <p className="small-text font-NeueMontreal text-[#f1f1f1]/60">
                        Participation Hub
                      </p>
                      <p className="paragraph font-NeueMontreal mt-[8px] text-[#f1f1f1]">
                        Report findings, vote on investigations
                      </p>
                    </div>
