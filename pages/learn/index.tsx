            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <p className="mt-2 text-sm font-NeueMontreal text-white/60">
                  Follow this path to become a budget-literate citizen
                </p>
              </motion.div>
              ...
              <div className="relative">
                ...
                <div className="absolute top-8 left-8 right-8 h-0.5 bg-white/10">
                  <motion.div
                    initial={{ width: 0 }}
                    whileInView={{ width: `${(currentStep / (learningSteps.length - 1)) * 100}%` }}
                    transition={{ duration: 0.5 }}
                    className="h-full bg-[#00aa55]"
                  />
                </div>
                  ...
                  {learningSteps.map((step, index) => (
                    <motion.button
                      ...
                      className={`relative p-4 rounded-xl text-left transition-all ${
                        currentStep === index
                          ? "bg-white/10 border border-[#00aa55]/50"
                    ...
                    >
                      ...
                      <h3 className="font-FoundersGrotesk text-sm font-medium">
                        {step.title}
                      </h3>
                      <p className="text-xs font-NeueMontreal text-white/50 mt-1">
                        {step.description}
                      </p>
                    </motion.button>
                  ))}
