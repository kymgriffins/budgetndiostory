...
// Copyright-free audio samples for testing (from free sound libraries)
const SAMPLE_AUDIOS = [
...
export default function Podcasts() {
    ...
    if (currentEpisode === episodeId) {
      ...
      if (audioRef.current) {
        audioRef.current.src =
          SAMPLE_AUDIOS[(episodeId - 1) % SAMPLE_AUDIOS.length];
        audioRef.current.play();
  ...
  useEffect(() => {
    ...
    // On mobile, use native scrolling without LocomotiveScroll
    if (isMobile) {
      // Apply fade-up animations on mobile without scroll library
      ...
      // Get all animated elements and apply initial styles
      const animatedElements = document.querySelectorAll(
        "[data-animate='fade-up'], [data-hero='sub'], [data-hero='title'], [data-hero='cta']",
      );
      ...
      const heroElements = document.querySelectorAll(
        "[data-hero='sub'], [data-hero='title'], [data-hero='cta']",
      );
  ...
  return (
    <>
      ...
      <div ref={scrollerRef} className="min-h-screen">
          ...
          <main className="w-full">
            ...
            <section className="padding-x padding-y min-h-[60vh] flex flex-col justify-center bg-gradient-to-br from-[#f1f1f1] to-white">
              <div className="max-w-[1200px] mx-auto w-full">
                ...
                >
                  Budget stories, conversations, and breakdowns for people who
                  prefer to listen while commuting, cooking, or studying.
                </p>
                ...
                >
                  <div className="grid grid-cols-2 gap-[30px] mdOnly:grid-cols-1 smOnly:grid-cols-1 xm:grid-cols-1">
                    ...
                    <div className="flex flex-col justify-between">
                      <div>
                        <p className="small-text font-NeueMontreal text-[#212121]/60 uppercase tracking-wide">
                          Episode 24
                        </p>
                        ...
                        <p className="mt-[16px] paragraph font-NeueMontreal text-[#212121]/70">
                          How much is spent on healthcare? Where do the gaps
                          exist? Why are health centers underfunded? This
                          episode breaks it down with data and real stories from
                          health workers.
                        </p>
                      ...
                      <div className="flex items-center gap-[12px] mt-[20px]">
                        <Link
                          href="/podcasts/1"
                          className="flex-1 px-[18px] py-[12px] rounded-full bg-[#212121] text-white paragraph font-NeueMontreal hover:opacity-90 transition flex items-center justify-center"
                        >
                          ▶ Listen Now
                        </Link>
                ...
                <div className="space-y-[14px]">
                  {episodes.map((ep, idx) => (
                    <Link
                      key={ep.id}
                      href={`/podcasts/${ep.id}`}
                      className="block rounded-[20px] bg-white border border-black/5 p-[22px] hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)] transition group cursor-pointer"
                    >
                      ...
                      <div className="mt-[16px] flex items-center gap-[10px]">
                        <button
                          ...
                          className="px-[14px] py-[8px] rounded-full bg-[#212121] text-white small-text font-NeueMontreal hover:opacity-90 transition flex items-center gap-[6px]"
                        >
                          {currentEpisode === ep.id && isPlaying ? (
                            <>
            ...
            <section className="padding-x padding-y">
              <div className="max-w-[1200px] mx-auto">
                <div
                  data-animate="fade-up"
                  className="rounded-[28px] bg-[#111] text-white border border-white/10 p-[26px]"
                >
                  <div className="flex items-center justify-between gap-[16px] flex-wrap">
                    <div>
                      ...
                      <p className="mt-[10px] paragraph font-NeueMontreal text-white/70">
                        Subscribe on your favorite podcast platform or get
                ...
                >
                  <div>
                    ...
                    <p className="mt-[10px] paragraph font-NeueMontreal text-[#212121]/70 max-w-[62ch]">
                      Prefer reading? Watch documentaries? Check out our stories
                      and shorts.
                    </p>
                  </div>
