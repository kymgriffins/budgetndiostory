...
export default function AdminBlog() {
  ...
  return (
    <>
      <Head>
        <title>Blog Admin - Budget Ndio Story</title>
              ...
              <div className="p-8 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-[12px] border border-[#212121]/15 bg-[#fafafa] text-[#212121] font-NeueMontreal focus:outline-none focus:border-[#212121]/30"
                    placeholder="budget, governance, analysis..."
                  />
                </div>
                ...
                {/* Actions */}
                <div className="flex items-center justify-end gap-3 pt-4 border-t border-[#212121]/10">
                  <button
                    onClick={resetForm}
                    className="px-6 py-3 text-[14px] font-NeueMontreal text-[#212121]/60 hover:text-[#212121] transition"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="px-6 py-3 bg-[#212121] text-white text-[14px] font-NeueMontreal rounded-full hover:opacity-90 transition disabled:opacity-50"
                  >
                    {loading
                      ? "Saving..."
                      : editingPost
