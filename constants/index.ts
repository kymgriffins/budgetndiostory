...
export const FaqItems = [
   {
      ...
      description: "Knowing how government and county budgets work empowers young people to make informed decisions, participate in civic matters, and plan their personal finances effectively.",
      links: [
         {
            id: 1,
            title: 1,
            description: "Budget literacy helps youth understand where public funds are allocated and how policies affect communities."
         },
         {
            id: 2,
            title: 2,
            description: "It also builds skills to manage personal finances, saving, and investment habits early in life."
         },
      ],
      button: "read"
   },
   {
      ...
      title: "Local Impact",
      description: "Government and county budgets determine funding for schools, roads, healthcare, and local projects. Understanding these budgets helps you hold leaders accountable and see how public resources are used.",
      links: [
         {
            id: 1,
            title: 1,
            description: "You can track which sectors receive more funding and identify opportunities to advocate for underfunded areas."
         },
      ],
      button: "read"
   },
      ...
      links: [
         {
            id: 1,
            title: 1,
            description: "Start with our simplified guides explaining national and county budgets step by step."
         },
         {
            id: 2,
            title: 2,
            description: "Use our interactive tools to simulate budget allocations and see how decisions impact communities."
         },
      ],
      button: "read"
   },
   {
      ...
      description: "Yes! Understanding the budget equips you to participate in consultations, advocacy, and civic engagement initiatives organized by government or youth groups.",
      links: [
         {
            id: 1,
            title: 1,
            description: "Attend public forums, join youth councils, or use Budget Ndiyo’s platform to learn how to voice your ideas effectively."
         },
      ],
      button: "read"
   },
      ...
      links: [
         {
            id: 1,
            title: 1,
            description: "Compare how different counties allocate funds for education, healthcare, and infrastructure."
         },
         {
            id: 2,
            title: 2,
            description: "Learn how your county spends taxes and discover opportunities to influence local development projects."
         },
      ],
      button: "read"
   },
      ...
      links: [
         {
            id: 1,
            title: 1,
            description: "Knowledge is power – the more youth understand budgets, the more effectively they can plan, save, and participate in governance."
         },
      ],
      button: "read"
   },
