...
export default function Chelenge() {
	return (
		<section className="w-full pb-[100px] lgOnly:pb-[80px] mdOnly:pb-[60px] smOnly:pb-[40px] xm:pb-[40px]">
			...
			<div className="w-[80%] mx-auto padding-x flex gap-[40px] smOnly:w-full xm:w-full smOnly:flex-col xm:flex-col">
				<div className="w-[49%] smOnly:w-full xm:w-full">
					<Image
						src={showcase1}
			...
			<div className="w-[80%] smOnly:w-full xm:w-full mx-auto padding-x flex gap-[20px]">
