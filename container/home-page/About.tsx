"use client";
import { FadeUp, HoverScale, LinkHover, ScaleIn } from "@/animation";
              ...
              <div className="w-full flex gap-[30px] h-full items-end smOnly:items-start smOnly:flex-col xm:items-start xm:flex-col">
                <div className="w-[40%] smOnly:w-[60%] xm:w-[60%]">
                  <p className="sub-paragraph font-medium font-NeueMontreal text-white tracking-wide">
                    ...
                    policy decisions impact communities.
                  </p>
                  <p className="sub-paragraph font-medium font-NeueMontreal text-white pt-[30px] tracking-wide">
                    Our approach combines clear explanations, interactive
                    visuals, and practical examples to make learning about
                    government, county finances, and civic responsibility
                    accessible and fun.
                  </p>
                </div>
